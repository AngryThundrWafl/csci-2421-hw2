...
namespace main_savitch_3
{
	...
	private:
		value_type bag1[CAPACITY];				//will store the values of first bag into this array bag1
		value_type bag2[CAPACITY];				//will store the values of the second bag into array bag2
		size_type used;							//index of the arrays
	...
	public:
		...
		void operator +(const value_type& target);


	private:
		value_type set1[CAPACITY];				//will store the values of first bag into this array bag1
		value_type set2[CAPACITY];				//will store the values of the second bag into array bag2
		size_type used;							//index of the arrays
